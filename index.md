...
* [PixelClient 1.8.8 - JS Edition for Mobile](PixelClient/JS-Edition/index.html) (Tablet ve Telefon oyncuları için en iyi seçenek. Not: bilgisayardan oynayacaksanız bunu değil yukardaki PixelClient'i seçin ya da şuna tıklayın: [PixelClient - 1.8.8](PixelClient/index.html))
